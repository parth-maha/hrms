...
namespace hrms_backend.Migrations
{
    ...
    [Migration("20260222172021_GameType2")]
    partial class GameType2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hrms_backend.Models.Entities.Games.GameInterest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("pk_game_interest_id");
                    ...
                    b.ToTable("game_interest");
                });

            modelBuilder.Entity("hrms_backend.Models.Entities.Games.GameSlots", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("pk_gs_id");
            ...
            modelBuilder.Entity("hrms_backend.Models.Entities.Games.GameType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("pk_game_type_id");
                    ...
                    b.Property<TimeSpan>("GameEndTime")
                        .HasColumnType("time")
                    ...
                    b.Property<TimeSpan>("GameStartTime")
                        .HasColumnType("time")
            ...
            modelBuilder.Entity("hrms_backend.Models.Entities.Travel.EmployeeTravelDocument", b =>
                {
                    ...
                    b.HasIndex("TravelExpenseId")
                        .IsUnique()
                        .HasFilter("[fk_expense_id] IS NOT NULL");
            ...
            modelBuilder.Entity("hrms_backend.Models.Entities.Games.GameInterest", b =>
                {
                    ...
                    b.HasOne("hrms_backend.Models.Entities.Games.GameType", "GameType")
                        .WithMany()
            ...
            modelBuilder.Entity("hrms_backend.Models.Entities.Games.GameSlots", b =>
                {
                    b.HasOne("hrms_backend.Models.Entities.Games.GameType", "Game")
                        .WithMany()
